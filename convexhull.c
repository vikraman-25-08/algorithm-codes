#include <stdio.h>
#include <stdlib.h>
#include <time.h> // Added for clock_t and clock()
...
left_hull = divide(a, mid_index, &left_size);
right_hull = divide(a + mid_index, n - mid_index, &right_size);
...
printf("Execution Time (CPU time): %f seconds\n", time_taken);
